...
func _ready() -> void:
	...
	var ALL_FIELD_CONTAINER_FIELDS := {
		...
		6: [
			...
			{'name': 'shadow_raystep_multiplier', 'type': 'float', 'from': 0.2, 'to': 3.0, 'default_value': 1.0},
		...
		22: [
			...
			{'name': 'connect_normal_to_epsilon', 'type': 'bool', 'default_value': true},
		],
		...
		# Modifiers / Base
		27: [
			{'name': 'base_shape', 'type': 'selection', 'values': ['Point', 'Sphere', 'Cube', 'Cylinder'], 'default_value': 'Point'},
		],
		# Modifiers / Repeat
		17: [
